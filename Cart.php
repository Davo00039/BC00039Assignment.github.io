...
<table width="100%" height="300px" style="border-collapse: collapse; text-align: center; border-bottom: 1px solid black;" >
    <thead>
        <tr class="cart_menu">
    ...
    <tbody>
        ...
        <tr style="border-bottom: 1px solid black;">
            <td class="cart_product" width="30%" style="border-right: 0; vertical-align: middle;  text-align: center;">
                    <a href=""><img width="0" src="admin/<?php echo $p["product_image"]; ?>" alt=""></a>
            </td >
            <td style="border-left: 0;>
                    <a href="#"><?php echo $p["product_name"]; ?></a>
            </td >
            <td class="cart_price" >
                <p style="text-align: center;"><?php echo number_format($p["product_price"],0); ?>$</p>
            </td>
            ...
            <td class="cart_total" width="20%">
                <p class="cart_total_price" style="text-align: center;"><?php  echo number_format($quantity*$p["product_price"],0); ?>$</p>
            </td>
        ...
        <tr><td colspan="6" style="text-align:right; font-size:20px;"><a href="index.php" class="btn btn-primary">Continue to buy</a></td></tr>
    </tbody>
</table>
            ...
            <div class="col-sm-6">
                <div class="total_area">
                    <div class="shopper-info">
                        <p style="font-size:20px">Shopper Information</p>
                        <form action="Checkout.php" method="POST">
                            <input type="text" name="address" style="width: 50%" value="<?php echo $_SESSION["user"]["user_address"]?>" placeholder="Input address">
                            <button type="submit" class="btn btn-primary" name="btnCheckout" Style="width: 25%; background-color: Black; color:white;">Checkout</button>
                        </form>
                    </div>
